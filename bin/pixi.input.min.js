...
t.hasOwnProperty(s)||(t[s]=a?{}:e[s]),a&&(h(t[s])||(t[s]={}),o(t[s],e[s]))}return t}function d(t){return c||t.determineFontHeight?t.determineFontHeight("font: "+t.style.font+";")+t.style.strokeThickness:parseInt(t.getFontProperties(t.style.font).fontSize,10)+t.style.strokeThickness}function u(e,i,s,a,h,n){if(n instanceof Array)var o=n[0],d=n[1],r=n[2],c=n[3]
...
var x=i.textboxHeight=a-2*o-c,b=i.textboxTop=o+I,f=i.textboxWidth=s-2*o-d,y=i.textboxLeft=o+p
if(!i.bgImage&&i.backgroundImage&&(i.bgImage=PIXI.Texture.fromImage(i.backgroundImage),i.bgImage.baseTexture.hasLoaded?i.dirty=!0:i.bgImage.on("update",function(){i.dirty=!0})),i.bgImage&&i.backgroundImage&&i.bgImage.baseTexture.hasLoaded)e.drawImage(i.bgImage,0,0,i.bgImage.width,i.bgImage.height,y,b,f,x)
else{if(i.backgroundGradient&&!h(i.backgroundColor)){var P=i.backgroundGradient.length
if(2>P)return
i.backgroundColor=e.createLinearGradient(0,0,0,a)
for(var m=0;P>m;m++){var w=i.backgroundGradient[m]
2===w.length?i.backgroundColor.addColorStop(w[0],w[1]):i.backgroundColor.addColorStop(m/(P-1),w)}}e.fillStyle=i.backgroundColor,u(e,y,b,f,x,n),e.fill()}e.shadowOffsetX=0,e.shadowOffsetY=0,e.shadowBlur=0
var O=i.innerShadow
O.blur>0&&(g.width=i.width+2*i.padding,g.height=i.height+2*i.padding,v.shadowBlur=O.blur,v.shadowColor=O.color,v.shadowOffsetX=0,v.shadowOffsetY=O.y,v.fillRect(-1*s,-100,3*s,100),v.shadowOffsetX=O.x,v.shadowOffsetY=0,v.fillRect(g.width,-1*a,100,3*a),v.shadowOffsetX=0,v.shadowOffsetY=O.y,v.fillRect(-1*s,g.height,3*s,100),v.shadowOffsetX=O.x,v.shadowOffsetY=0,v.fillRect(-100,-1*a,100,3*a),u(e,o+p,o+I,s-2*o-d,a-2*o-c,n),e.clip(),e.drawImage(g,0,0,g.width,g.height,o+p,o+I,g.width,g.height))},PIXI.InputObject=function(e){if(this.tabIndex=e!==t?e:PIXI.InputObject.tabIndex++,PIXI.Sprite.call(this,PIXI.Texture.fromCanvas(this.canvas)),PIXI.InputObject.inputs.push(this),this.resolution=1,!l){if(!PIXI.InputObject.hiddenInput){var s=document.createElement("input")
...
var a=this.textWidth(e),h=e.length,n=this.data.width-this.data.padding,o=e
if(i&&e!==this.data.placeholder&&(this.data.cursorPos=this.data.cursorPos||0,h<this.data.clipPos[0]&&(this.data.clipPos[0]=0),this.data.cursorPos>this.data.clipPos[1]?(s=this.data.clipPos[0],e=e.substr(s,this.data.cursorPos-this.data.clipPos[0])||""):this.data.cursorPos<this.data.clipPos[0]?(s=this.data.cursorPos,e=e.substr(s)||""):(s=this.data.clipPos[0],e=e.substr(s)),e!==o&&(a=this.textWidth(e),h=e.length)),a>n)for(var d=this.textCache,u="";a>n;)i&&this.data.cursorPos>this.data.clipPos[1]?(u=e[0],d[u]=d[u]||this.textWidth(u),a-=d[u],e=e.substr(1,--h),s++):(u=e[--h],d[u]=d[u]||this.textWidth(u),a-=d[u],e=e.substr(0,h))
...
e.shiftKey}return 27===e.which?(this.blur(),t):(this._textNeedsUpdate=!0,this._selectionNeedsUpdate=!0,this.data.onkeydown(e,this),32===i||13===i?(e.preventDefault(),this.menu.visible?(this.displayMenu(!1),this.menu.selectedIndex&&(this.selectedIndex=this.menu.selectedIndex,this.menu.selectedIndex=null,this.updateText())):this.displayMenu(!0),t):9===i?(PIXI.InputObject.Tab(e,i,this),t):(38===i&&(this.selectedIndex--,this.selectedIndex<0&&(this.selectedIndex=0),this.updateText()),40===i&&(this.selectedIndex++,this.selectedIndex>=this.options.length&&(this.selectedIndex=this.options.length-1),this.updateText()),t))},onKeyUp:function(t){this.data.onkeyup(t,this),this.menu.selectedIndex||this.updateText()},onMouseDown:function(t){this.focus(),this.data.mouseDown=!0,this.data.onmousedown(t,this)},onMouseUp:function(t){this.data.onmouseup(t,this),this.data.mouseDown=!1,this.focus(),this.displayMenu(!this.menu.visible)},displayMenu:function(t){if(this.menu.visible=t,this.selection.visible=!1,this.optiontexts.visible=!1,t){this.menu.x=this.data.textboxLeft,this.menu.width=this.data.textboxWidth,this.selection.x=this.data.textboxLeft,this.selection.width=this.data.textboxWidth,this.selection.height=this.lineHeight
var e=this.stage?this.stage.interactionManager.target.height:0,i=this.y-this.height*this.anchor.y,s=e-(i+this.height)
this.menu.height>s&&i>s?(this.menu.anchor.y=1,this.menu.y=1):(this.menu.anchor.y=0,this.menu.y=this.height-1),this.menu.startY=this.menu.y-this.menu.height*this.menu.anchor.y,this.menu.selectedIndex=null,this.optiontexts.y=this.menu.startY,this.optiontexts.x=5,this.optiontexts.visible=!0,this.value&&(this.selection.visible=!0,this.updateSelection())}},update:function(t){(t||this.data.dirty||this._textNeedsUpdate||this._textStyleNeedsUpdate)&&(this.data.dirty&&(this.renderTexture(),this.data.dirty=!1),this._textStyleNeedsUpdate&&(this.text.setStyle(this.data.text),this._textStyleNeedsUpdate=!1),this._textNeedsUpdate&&(this.text.setText(this.data.value||""),this.text.updateText(),this._textNeedsUpdate=!1))},renderTexture:function(){PIXI.ButtonFactory(this.canvas,this.context,this.data),PIXI.ButtonFactory(y,P,{backgroundGradient:["#bbb","#eee","#bbb"],borderWidth:1,borderColor:this.data.borderColor,borderRadius:[0,this.data.borderRadius,this.data.borderRadius,0],boxShadow:"none",innerShadow:"none",padding:0,width:25,height:this.data.outerHeight}),P.beginPath(),P.moveTo(9+this.data.borderWidth-2,this.data.outerHeight/3+this.data.borderWidth+1),P.lineTo(17-this.data.borderWidth,this.data.outerHeight/3+this.data.borderWidth+1),P.lineTo(12,2*this.data.outerHeight/3-this.data.borderWidth+2),P.closePath(),P.fillStyle="#000",P.fill(),this.context.drawImage(y,0,0,25,this.data.outerHeight,this.data.outerWidth-25,0,25,this.data.outerHeight),"none"!==this.data.valign&&this.data.valign?"middle"===this.data.valign?this.text.y=this.data.textboxTop+(this.data.textboxHeight-this.text.height)/2|0:"top"===this.data.valign?this.text.y=0|this.data.textboxTop:"bottom"===this.data.valign&&(this.text.y=this.data.textboxTop+this.data.textboxHeight-this.text.height|0):this.text.y=0|this.data.padding,this.text.x=this.data.textboxLeft+this.data.padding|0,this.updateTexture()},updateTransform:function(){this.update(),PIXI.Sprite.prototype.updateTransform.call(this)},destroy:function(){this.text.destroy(!0),PIXI.InputObject.prototype.destroy.call(this)}},!0),Object.defineProperty(PIXI.Select.prototype,"value",{get:function(){return this.options[this.selectedIndex]?this.options[this.selectedIndex]:null},set:function(){}})}()
